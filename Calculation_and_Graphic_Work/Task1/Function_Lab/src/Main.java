...
public class Main
{
    public static void main(String[] args)
    {
        ...
        compute_and_save("function1_1.txt", function1, x_start, x_end, step, epsilon);
        ...
        for(double a: a_values)
        {
            ...
            compute_and_save("function2_a" + a + "_1.txt", function2, x_start, x_end, step, epsilon);
        }
        ...
        compute_and_save("function3_tabular_1.txt", function3, x_start, x_end, step, epsilon);
